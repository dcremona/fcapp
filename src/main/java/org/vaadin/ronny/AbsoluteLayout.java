...
public class AbsoluteLayout extends Component implements HasSize, HasOrderedComponents, ThemableLayout {
    ...
    /**
     * Creates a new instance of the AbsoluteLayout which uses 100% of the height
    ...
    /**
     * Creates a new instance of the AbsoluteLayout with the given width and height.
     * Everything outside this rectangle with <i>not</i> be displayed (it will be
     * rendered though).
     *
     * @param width
     *            A nonnegative width
     * @param height
     *            A nonnegative height
     */
    ...
    /**
     * Add a component at the given position. Layouting starts at the top left
     * corner of the layout and is relative to that.
     * 
     * @param c
    ...
    // layout.
    // * It is recommended to use {@link #add(Component, int, int)} with an instance
