...
public class Buffer extends javax.swing.table.AbstractTableModel implements ComboBoxModel<Object> {
    ...
    /**
     * Metodo utilizzato per impostare una propriet@ del Buffer che quando @ true
     * permette al metodo setSortField(int) di ordinare il Buffer anche se risulta
     * essere gi@ ordinato per la stessa colonna indicata in setSortField(int).
     *
     * @param bSortAlways
     *            Se True permette di ordinare il Buffer per una colonna anche se
     *            risulta gi@ ordinato per la stessa colonna.
     * @see #setSortedField(int)
     * @see #isSortedAlways()
     */
     ...
     * metodo addNew, quando il record che si vuole aggiungere, supera la capacit@
     * attuale.
     *
     ...
     *
     * @param aiRecord
     *            Array di interi indicante quali record che si vogliono 'clonare'
     *            dal Buffer attuale.
     * @return Un'istanza distinta del Buffer attuale.
     * @see #getClone()
     ...
     *
     * @param col
     *            Intero indicante il numero del campo per il qualesi vuole ordinare
     *            il Buffer.
     * @see #sort(int[])
     */
     ...
     *
     * @param colonne
     *            Array di interi indicante l'ordine crescente delle colonne per le
     *            quali si vuol ordinare il Buffer.
     * @see #sort(int)
     */
    ...
    /**
     * Metodo che restituisce il valore massimo di un campo del buffer, sia che si
     * tratti di un numero,di una stringa o di una data.
     *
     * @param col
    ...
    /**
     * Metodo che restituisce il valore minimo di un campo del buffer, sia che si
     * tratti di un numero, di una stringa o di una data.
     *
     * @param col
     ...
     *
     * @param field
     *            Numero del campo (del record correntemente puntato) del quale si
    ...
    public void setTypeCampiBuffer(String asFieldType[], int iFieldCount, int iRecordCount) {
    ...
    public void setRecordSet(String RecordSet[][], String asFieldType[], int iFieldCount, int iRecordCount) {
         ...
         * i=0;i<iRecordCount;i++) for(int c=0;c<iFieldCount;c++) theRecordSet[i][c] =
         * RecordSet[i][c];
         */
     ...
     *
     * @param columnNames
     *            Array di String contenenti i nomi da impostare alle colonne del
     *            Buffer.
     */
