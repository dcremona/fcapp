...
public class Utils {
    ...
    // public static StreamResource getStreamResource(String nomeImg, java.sql.Blob
    // blob) {
    //
    // StreamResource resource = new StreamResource(nomeImg,() -> {
    ...
    public static StreamResource getStreamResource(String fiileName, Collection coll, Map<String, Object> hm,
            InputStream inputStream) {
        return new StreamResource(fiileName, () -> {
            try {
