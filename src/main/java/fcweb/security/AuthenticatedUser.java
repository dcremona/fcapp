...
public class AuthenticatedUser {
    ...
    public AuthenticatedUser(AuthenticationContext authenticationContext, AttoreRepository userRepository) {
        this.userRepository = userRepository;
        this.authenticationContext = authenticationContext;
    }

    public Optional<FcAttore> get() {
        Optional<FcAttore> maybeUser = authenticationContext.getAuthenticatedUser(UserDetails.class)
    ...
    private Date getCalendarCountDown(String currentDataGiornata, String fusoOrario) {
