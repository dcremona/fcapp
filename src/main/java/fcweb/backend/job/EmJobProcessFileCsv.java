...
public class EmJobProcessFileCsv {
    ...
    public void downloadCsvOLD(String http_url, String path_csv, String fileName, int giornata) throws Exception {
         ...
         *
         * // Write to temp file output = new BufferedWriter(new FileWriter(temp));
         * output.write(data); output.close();
         *
         * // DELETE File f = new File(path_csv + fileName + ".csv"); if (f.exists()) {
         * f.delete(); }
         *
         * File dest = new File(path_csv + fileName + ".csv"); // Move file to new
         * directory boolean success = temp.renameTo(dest); if (!success) { // File was
         * not successfully moved LOG.error("File was not successfully moved " +
         * success); }
         *
         * } catch (IOException e) { LOG.error(e.getMessage()); } finally { if (output
         * != null) { output.close(); } }
         */
    }
