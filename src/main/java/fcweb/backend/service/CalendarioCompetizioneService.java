...
public class CalendarioCompetizioneService {
    ...
    @Autowired
    public CalendarioCompetizioneService(CalendarioCompetizioneRepository calendarioTimRepository) {
        this.calendarioTimRepository = calendarioTimRepository;
    }

    public List<FcCalendarioCompetizione> findAll() {
        List<FcCalendarioCompetizione> l = (List<FcCalendarioCompetizione>) calendarioTimRepository
                .findAll(sortByIdAsc());
        return l;
    }
    ...
    public List<FcCalendarioCompetizione> findByIdGiornataAndDataLessThanEqual(int idGiornata, LocalDateTime data) {
        List<FcCalendarioCompetizione> l = calendarioTimRepository.findByIdGiornataAndDataLessThanEqual(idGiornata,
                data);
        return l;
    }
