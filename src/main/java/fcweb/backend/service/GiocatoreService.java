...
public class GiocatoreService {
    ...
    public List<FcGiocatore> findByFcRuoloAndFlagAttivoAndIdGiocatoreNotInOrderByQuotazioneDesc(FcRuolo ruolo,
        ...
        List<FcGiocatore> l = giocatoreRepository
                .findByFcRuoloAndFlagAttivoAndIdGiocatoreNotInOrderByQuotazioneDesc(ruolo, flagAttivo, giocatore);
        return l;
    }

    public List<FcGiocatore> findByFlagAttivoAndFcSquadraAndIdGiocatoreNotInOrderByFcRuoloDescQuotazioneDesc(
            FcRuolo ruolo, boolean flagAttivo, FcSquadra squadra, Collection<Integer> giocatore) {
        List<FcGiocatore> l = giocatoreRepository
                .findByFlagAttivoAndFcSquadraAndIdGiocatoreNotInOrderByFcRuoloDescQuotazioneDesc(flagAttivo, squadra,
                        giocatore);
        return l;
    }
