...
public class StatisticheService {
    ...
    public FcStatistiche updateStatistiche(@RequestParam("statistiche") FcStatistiche statistiche) {
    ...
    public String deleteStatistiche(@RequestParam("statistiche") FcStatistiche statistiche) {
        String id = "";
        try {
