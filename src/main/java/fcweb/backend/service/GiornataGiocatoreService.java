...
public class GiornataGiocatoreService {
    ...
    @Autowired
    public GiornataGiocatoreService(GiornataGiocatoreRepository giornataGiocatoreRepository) {
    ...
    public List<FcGiornataGiocatore> findByCustonm(FcGiornataInfo giornataInfo, FcGiocatore giocatore) {
