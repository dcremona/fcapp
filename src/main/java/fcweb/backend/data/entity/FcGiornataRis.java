...
public class FcGiornataRis implements java.io.Serializable {
    ...
    public FcGiornataRis(FcGiornataRisId id, FcAttore fcAttore, FcGiornataInfo fcGiornataInfo, int idRisPartita) {
        this.id = id;
    ...
    public FcGiornataRis(FcGiornataRisId id, FcAttore fcAttore, FcGiornataInfo fcGiornataInfo, Integer fm, Integer gf,
            Integer gs, int idRisPartita, Integer nulla, Integer persa, Integer punti, Integer vinta) {
        this.id = id;
        this.fcAttore = fcAttore;
        this.fcGiornataInfo = fcGiornataInfo;
        this.fm = fm;
