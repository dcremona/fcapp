...
public class FcClassifica implements java.io.Serializable {
    ...
    public FcClassifica(FcClassificaId id, FcAttore fcAttore, FcCampionato fcCampionato, int dr, int fmMercato, int gf,
            int gs, int idPosiz, int idPosizFinal, int pari, int perse, int punti, int totFm, int vinte) {
        this.id = id;
    ...
    public FcClassifica(FcClassificaId id, FcAttore fcAttore, FcCampionato fcCampionato, int dr, int fmMercato, int gf,
            int gs, int idPosiz, int idPosizFinal, int pari, int perse, int punti, int totFm, Double totPunti,
            Double totPuntiOld, Double totPuntiRosa, int vinte) {
        this.id = id;
        this.fcAttore = fcAttore;
        this.fcCampionato = fcCampionato;
        this.dr = dr;
