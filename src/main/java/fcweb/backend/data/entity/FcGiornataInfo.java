...
public class FcGiornataInfo implements java.io.Serializable {
    ...
    public FcGiornataInfo(int codiceGiornata, String descGiornata, String descGiornataFc, int idGiornataFc) {
    ...
    public FcGiornataInfo(int codiceGiornata, LocalDateTime dataAnticipo1, LocalDateTime dataAnticipo2,
            LocalDateTime dataGiornata, LocalDateTime dataPosticipo, String descGiornata, String descGiornataFc,
            int idGiornataFc, Set<FcGiornataRis> fcGiornataRises, Set<FcGiornataDett> fcGiornataDetts,
            Set<FcPagelle> fcPagelles, Set<FcGiornataDettInfo> fcGiornataDettInfos, Set<FcGiornata> fcGiornatas,
            Set<FcClassificaTotPt> fcClassificaTotPts, Set<FcMercatoDett> fcMercatoDetts) {
        this.codiceGiornata = codiceGiornata;
    ...
    public void setFcGiornataDettInfos(Set<FcGiornataDettInfo> fcGiornataDettInfos) {
        this.fcGiornataDettInfos = fcGiornataDettInfos;
    }
