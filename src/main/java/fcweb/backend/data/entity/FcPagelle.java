...
public class FcPagelle implements java.io.Serializable {
    ...
    public FcPagelle(FcPagelleId id, FcGiocatore fcGiocatore, FcGiornataInfo fcGiornataInfo, int ammonizione,
            int assist, int autorete, int espulsione, int goalRealizzato, int goalSubito, int rigoreFallito,
            int rigoreParato, int rigoreSegnato, int votoGiocatore) {
        this.id = id;
    ...
    public FcPagelle(FcPagelleId id, FcGiocatore fcGiocatore, FcGiornataInfo fcGiornataInfo, int ammonizione,
            int assist, int autorete, Double cs, int espulsione, Double g, int goalRealizzato, int goalSubito,
            int rigoreFallito, int rigoreParato, int rigoreSegnato, Double ts, int votoGiocatore,
