...
@RolesAllowed("USER")
public class TeamInsertView extends VerticalLayout implements ComponentEventListener<ClickEvent<Button>> {
    ...
    private void initData() {
        ...
        listPartiteGiocate = calendarioTimController
                .findByIdGiornataAndDataLessThanEqual(giornataInfo.getCodiceGiornata(), now);
    ...
    private void setPopover(Component cellLayout, FcGiocatore g) {
        ...
        final VerticalLayout contentInfo = new VerticalLayout();
        ...
        if (g.getFcSquadra() != null) {
            ...
            info2.setMargin(false);
            info2.setPadding(false);
            info2.setSpacing(false);

            if (g.getImgSmall() != null) {
                try {
        ...
        if (g.getFcSquadra() != null) {
            ...
            info3.setPadding(false);
            info3.setSpacing(false);
        ...
        if (s != null && s.getMediaVoto() != 0) {
            ...
            infoMv.setPadding(false);
            infoMv.setSpacing(false);
            ...
            NumberFormat formatter = new DecimalFormat(Costants.NUMBER_DECIMAL);
        ...
        if (s != null && s.getFantaMedia() != 0) {
            ...
            infoFv.setPadding(false);
            infoFv.setSpacing(false);
            ...
            Image imgFv = Utils.buildImage(imgThink, resourceLoader.getResource(Costants.CLASSPATH_IMAGES + imgThink));
            infoFv.add(imgFv);
    ...
    private void refreshAndSortGridFormazione() {
        modelFormazione
                .sort((p1, p2) -> p2.getFcRuolo().getIdRuolo().compareToIgnoreCase(p1.getFcRuolo().getIdRuolo()));
    ...
    private ArrayList<FcGiocatore> getModelFormazione() {
        ...
        List<FcFormazione> listFormazione = formazioneController
                .findByFcCampionatoAndFcAttoreOrderByFcGiocatoreFcRuoloDescTotPagatoDesc(campionato, attore, false);
    ...
    private Grid<FcGiocatore> getTableFormazione(List<FcGiocatore> items) {
        ...
        grid.setSelectionMode(Grid.SelectionMode.NONE);
        grid.setAllRowsVisible(true);
        grid.setWidth(Costants.WIDTH_330);
    ...
    private void loadFcGiornatadett() {
        ...
        List<FcGiornataDett> lGiocatori = giornataDettController
    ...
    private boolean check() {
        ...
        if (modelPlayer1.isEmpty() || modelPlayer2.isEmpty() || modelPlayer3.isEmpty() || modelPlayer4.isEmpty()
                || modelPlayer5.isEmpty() || modelPlayer6.isEmpty() || modelPlayer7.isEmpty() || modelPlayer8.isEmpty()
                || modelPlayer9.isEmpty() || modelPlayer10.isEmpty() || modelPlayer11.isEmpty()
                || modelPlayer12.isEmpty() || modelPlayer13.isEmpty() || modelPlayer14.isEmpty()
                || modelPlayer15.isEmpty() || modelPlayer16.isEmpty() || modelPlayer17.isEmpty()
                || modelPlayer18.isEmpty()) {
    ...
    private void insertDettInfo(int giornata, String dataora) throws Exception {
        ...
        try {
            ...
            query = " INSERT INTO fc_giornata_dett_info (ID_GIORNATA,ID_ATTORE, FLAG_INVIO,DATA_INVIO) VALUES ("
                    + giornata + ",";
    ...
    private void sendNewMail(String descGiornata) throws Exception {
        ...
        try {
            ...
            emailService.sendMail2(false, from, to, cc, bcc, subject, formazioneHtml.toString(), "text/html", "3",
                    listImg);
        } catch (Exception e) {
            log.error(e.getMessage());
            try {
                String from = env.getProperty("spring.mail.primary.username");
                emailService.sendMail2(true, from, to, cc, bcc, subject, formazioneHtml.toString(), "text/html", "3",
                        listImg);
            } catch (Exception e2) {
    ...
    private void showMessageErrorChangeModulo(FcGiocatore g) {
        ...
        refreshAndSortGridFormazione();
        CustomMessageDialog
                .showMessageError("Cambio modulo incorretto! Impossibile muovere il giocatore " + g.getCognGiocatore());
    }
