...
@RolesAllowed("ADMIN")
public class ImpostazioniView extends VerticalLayout implements ComponentEventListener<ClickEvent<Button>> {
    ...
    public void onComponentEvent(ClickEvent<Button> event) {
        ...
        try {
            ...
            if (event.getSource() == initDb) {
                ...
                HashMap<Object, Object> map = jobProcessGiornata.initDbGiocatori(Costants.HTTP_URL_IMG, imgPath,
                        fileName, updateQuotazioni, updateImg, percentuale);
                ...
                jobProcessGiornata.algoritmo(codiceGiornata, campionato, forzaVotoGiocatore,
                        chkRoundVotoGiocatore.getValue());
                jobProcessGiornata.statistiche(campionato);

                jobProcessGiornata.aggiornaVotiGiocatori(codiceGiornata, forzaVotoGiocatore,
                        chkRoundVotoGiocatore.getValue());
