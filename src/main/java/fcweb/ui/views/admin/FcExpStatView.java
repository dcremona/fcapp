...
@RolesAllowed("ADMIN")
public class FcExpStatView extends VerticalLayout implements ComponentEventListener<ClickEvent<Button>> {
    ...
    private void initLayout() {
        ...
        crud.getCrudFormFactory().setVisibleProperties(CrudOperation.READ, "id", "anno", "campionato", "p2", "p3", "p4",
                "p5", "p6", "p7", "p8", "scudetto", "winClasPt", "winClasReg", "winClasTvsT");
        crud.getCrudFormFactory().setVisibleProperties(CrudOperation.ADD, "id", "anno", "campionato", "p2", "p3", "p4",
                "p5", "p6", "p7", "p8", "scudetto", "winClasPt", "winClasReg", "winClasTvsT");
        crud.getCrudFormFactory().setVisibleProperties(CrudOperation.UPDATE, "anno", "campionato", "p2", "p3", "p4",
                "p5", "p6", "p7", "p8", "scudetto", "winClasPt", "winClasReg", "winClasTvsT");
