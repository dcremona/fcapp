...
public class FcMercatoDettView extends VerticalLayout {
    ...
    private void initLayout() {
        ...
        formFactory.setVisibleProperties(CrudOperation.READ, "id", "fcGiornataInfo", "fcAttore",
                "fcGiocatoreByIdGiocVen", "fcGiocatoreByIdGiocAcq", "dataCambio", "nota");
        formFactory.setVisibleProperties(CrudOperation.ADD, "id", "fcGiornataInfo", "fcAttore",
                "fcGiocatoreByIdGiocVen", "fcGiocatoreByIdGiocAcq", "dataCambio", "nota");
        formFactory.setVisibleProperties(CrudOperation.UPDATE, "id", "fcGiornataInfo", "fcAttore",
                "fcGiocatoreByIdGiocVen", "fcGiocatoreByIdGiocAcq", "dataCambio", "nota");
        formFactory.setVisibleProperties(CrudOperation.DELETE, "id", "fcGiornataInfo", "fcAttore",
                "fcGiocatoreByIdGiocVen", "fcGiocatoreByIdGiocAcq");

        crud.getGrid().setColumns("id", "fcAttore", "fcGiocatoreByIdGiocVen", "fcGiocatoreByIdGiocAcq",
                "fcGiornataInfo", "dataCambio", "nota");
        ...
        crud.getGrid().addColumn(new TextRenderer<>(
                ...
                .setHeader("Giornata");
        crud.getGrid().addColumn(new TextRenderer<>(g -> g != null ? g.getFcAttore().getDescAttore() : ""))
                .setHeader("Attore");
        crud.getGrid()
                .addColumn(new TextRenderer<>(g -> g != null && g.getFcGiocatoreByIdGiocVen() != null
                        ? "" + g.getFcGiocatoreByIdGiocVen().getCognGiocatore()
                        : ""))
                .setHeader("Gioc Ven");
        crud.getGrid()
                .addColumn(new TextRenderer<>(g -> g != null && g.getFcGiocatoreByIdGiocAcq() != null
                        ? "" + g.getFcGiocatoreByIdGiocAcq().getCognGiocatore()
                        : ""))
                .setHeader("Gioc Acq");
        ...
        formFactory.setFieldProvider("fcGiornataInfo",
        ...
        formFactory.setFieldProvider("fcAttore", new ComboBoxProvider<>("Attore", attoreController.findByActive(true),
                new TextRenderer<>(FcAttore::getDescAttore), FcAttore::getDescAttore));
        formFactory.setFieldProvider("fcGiocatoreByIdGiocVen",
                new ComboBoxProvider<>("Gioc Acq", giocatoreController.findAll(),
                        new TextRenderer<>(FcGiocatore::getCognGiocatore), FcGiocatore::getCognGiocatore));
        formFactory.setFieldProvider("fcGiocatoreByIdGiocAcq",
                new ComboBoxProvider<>("Gioc Ven", giocatoreController.findAll(),
                        new TextRenderer<>(FcGiocatore::getCognGiocatore), FcGiocatore::getCognGiocatore));
