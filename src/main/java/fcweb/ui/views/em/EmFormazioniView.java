...
public class EmFormazioniView extends VerticalLayout {
    ...
    private void initImg() throws Exception {
        ...
        iconGolVittoria_ = Utils.buildImage("golvittoria.png",
                resourceLoader.getResource(Costants.CLASSPATH_IMAGES + "golvittoria.png"));
    ...
    private void buildTabGiornata(VerticalLayout layout, String giornata) {
        ...
        for (FcAttore a : squadre) {
            ...
            try {
                ...
                Grid<FcGiornataDett> tableSqCasaTitolari = buildResultSquadra(itemsCasaTitolari, "Titolari",
                        schemaCasa);
    ...
    private HashMap<String, Object> buildData(FcAttore attore, FcGiornataInfo giornataInfo) throws Exception {
            ...
            if (gd != null && gd.getFcGiocatore() != null) {
                ...
                for (int a = 0; a < gd.getFcPagelle().getAmmonizione(); a++) {
                    info.add(Utils.buildImage("amm_s.png",
                            resourceLoader.getResource(Costants.CLASSPATH_IMAGES + "amm_s.png")));
                }
                ...
                for (int a = 0; a < gd.getFcPagelle().getGoalSubito(); a++) {
                    info.add(Utils.buildImage("golsubito_s.png",
                            resourceLoader.getResource(Costants.CLASSPATH_IMAGES + "golsubito_s.png")));
                }
                ...
                for (int a = 0; a < gd.getFcPagelle().getGdv(); a++) {
                    info.add(Utils.buildImage("golvittoria_s.png",
                            resourceLoader.getResource(Costants.CLASSPATH_IMAGES + "golvittoria_s.png")));
                }
