...
public class EmImpostazioniView extends VerticalLayout implements ComponentEventListener<ClickEvent<Button>> {
    ...
    // image.getElement().setAttribute("src", new StreamResource(fileName,() -> new
    ...
    public void onComponentEvent(ClickEvent<Button> event) {
        ...
        try {
            ...
            if (event.getSource() == initDb) {
                ...
                HashMap<Object, Object> map = emjobProcessGiornata.initDbGiocatori(Costants.HTTP_URL_IMG, imgPath,
                        fileName, updateQuotazioni, percentuale);
                ...
                collection.add(new RisultatoBean("P", "S1", Double.valueOf(6), Double.valueOf(6), Double.valueOf(6),
                        Double.valueOf(6)));
    ...
    private Map<String, Object> getMap(int giornata, String pathImg) {
        ...
        for (FcAttore a : squadre) {
            ...
            List<FcGiornataDett> lGiocatori = giornataDettController
                    .findByFcAttoreAndFcGiornataInfoOrderByOrdinamentoAsc(a, giornataInfo);
            FcClassificaTotPt totPunti = classificaTotalePuntiController.findByFcAttoreAndFcGiornataInfo(a,
                    giornataInfo);
            ...
            String puntiTotali = "";
            if (totPunti != null) {
                puntiTotali = formatter
                        .format(totPunti.getTotPt().doubleValue() / Double.parseDouble("" + Costants.DIVISORE_10));
            }
