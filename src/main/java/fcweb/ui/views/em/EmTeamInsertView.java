...
@RolesAllowed("USER")
public class EmTeamInsertView extends VerticalLayout implements ComponentEventListener<ClickEvent<Button>> {
    ...
    private void initLayout() throws Exception {
        ...
        List<FcCalendarioCompetizione> listPartite = calendarioTimController
                .findByIdGiornataOrderByDataAsc(giornataInfo.getCodiceGiornata());
    ...
    private void loadFcGiornatadett(FcAttore attore, FcGiornataInfo giornataInfo) throws Exception {
    ...
    private void insert_dett_info(int giornata, String dataora) throws Exception {
