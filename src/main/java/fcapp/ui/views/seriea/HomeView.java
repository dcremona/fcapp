...
public class HomeView extends VerticalLayout {
    ...
    private static final String SESSION_MILLIS_DIFF = "MILLISDIFF";
    ...
    public HomeView(
            ...
            GiornataRisService giornataRisService,
    ...
    private HorizontalLayout buildInfoGiornate() {
        ...
        if (giornataCorrente.getCodiceGiornata() > 1) {
            FcGiornataInfo giornataPrecedente =
                    giornataInfoService.findByCodiceGiornata(giornataCorrente.getCodiceGiornata() - 1);

            wrapper.add(buildGiornataPanel(
                    "Ultima Giornata - " + Utils.buildInfoGiornata(giornataPrecedente),
                    giornataPrecedente));
        }

        wrapper.add(buildGiornataPanel(
                "Prossima Giornata - " + Utils.buildInfoGiornata(giornataCorrente),
                giornataCorrente));
    ...
    private VerticalLayout buildLayoutAvviso() {
        ...
        Long millisDiff = getSessionAttribute(SESSION_MILLIS_DIFF, Long.class);
        ...
        long seconds = millisDiff == null ? 0L : millisDiff / 1000;
        ...
        for (FcGiornata partita : partite) {
            ...
            if (isCasa || isFuori) {
                ...
                return new MatchInfo(
                        description,
                        formatGolPartita(partita),
                        formatTotaliPartita(partita));
            }
        }
